...
const sideNav = tv({
  base: "fixed top-0 right-0 z-99 w-full h-dvh flex flex-col bg-background w-64 px-1",
  slots: {
    ...
    children: "flex flex-col w-full overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden",
