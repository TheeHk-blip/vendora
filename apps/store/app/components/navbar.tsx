    ...
    <Navbar 
      ...
      actions={
        <>
          {session ? (            
            <>
              <Avatar sx={{ width: 35, height: 35 }} src={session.user.image} className="ring ring-transparent" />              
            </>
          ):(
            <>
              <Link 
                href={`${process.env.BASE_URL}/onboarding`}
              ...
              <Link
                href={`${process.env.BASE_URL}/signin`}
